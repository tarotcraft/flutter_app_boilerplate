...
public class AsrManager {
    ...
    private AsrEventAdapter asrEventAdapter;
     ...
     *
     * @param context
     * @param asrListener 识别状态和结果回调
     */
    public AsrManager(Context context, OnAsrListener asrListener) {
        if (isInited) {
        ...
        asr.registerListener(asrEventAdapter = new AsrEventAdapter(asrListener));
    }
    ...
    public void release() {
        ...
        asr.unregisterListener(asrEventAdapter);
        asr = null;
        isInited = false;
    }
}
