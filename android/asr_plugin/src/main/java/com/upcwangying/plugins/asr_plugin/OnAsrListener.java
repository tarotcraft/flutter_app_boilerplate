...
public interface OnAsrListener {
     ...
     * @param asrResult 完整的结果
     */
    void onAsrPartialResult(String[] results, AsrResult asrResult);
     ...
     * @param asrResult 完整的结果
     */
    void onAsrFinalResult(String[] results, AsrResult asrResult);

    /**
     * CALLBACK_EVENT_ASR_FINISH
     * @param asrResult 结束识别
     */
