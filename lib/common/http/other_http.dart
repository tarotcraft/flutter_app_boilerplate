...
final OtherHttp trendingHttp = OtherHttp(GitterConstants.githubTrendingApiPrefix);
final OtherHttp contributionsHttp = OtherHttp(GitterConstants.githubOtherApiPrefix);
